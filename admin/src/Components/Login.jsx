        ...
        <div className='bg-white shadow-md rounded-lg px-8 py-6 w-full max-w-md'>
          ...
          <form onSubmit={OnSubmitHandler}>
            ...
            <div className='mb-4'>
              ...
              <input type="password" value={password} onChange={(p) => setPassword(p.target.value)}  placeholder='Enter Password' required className='w-[95%] px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:border-gray-800'/>
            </div>
